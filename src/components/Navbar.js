...
const Navbar = () => {
  ...
  return (
    <div className='rounded-div flex items-center justify-between h-20 font-bold'>
        <Link to='/'>
            <h1 className='text-4xl'>Crypto House</h1>
        </Link>
        <ul className='flex gap-5 cursor-pointer'>
            <li className='hover:text-accent'>Explore</li>
            <li className='hover:text-accent'>Learn</li>
            <li className='hover:text-accent'>Exchanges</li>
